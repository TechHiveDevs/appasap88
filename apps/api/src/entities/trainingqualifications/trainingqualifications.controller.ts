...
/**
 * Trainingqualifications Controller
 * ====================
 * @author MarioMonir
 */
...
/**
 * import { Trainingqualifications } from "@prisma/client";
 * import { trainingqualificationsUseCase1Service } from "./trainingqualifications-services/trainingqualificationsUseCase1.service";
 */

// ----------------------------------------------------------------

const entity = `trainingqualifications`;
const path = `/trainingqualifications`;
