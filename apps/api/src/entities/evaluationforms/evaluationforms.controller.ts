...
/**
 * import { Evaluationforms } from "@prisma/client";
 * import { evaluationformsUseCase1Service } from "./evaluationforms-services/evaluationformsUseCase1.service";
 */

// ----------------------------------------------------------------

const entity = `evaluationforms`;
const path = `/evaluationforms`;
