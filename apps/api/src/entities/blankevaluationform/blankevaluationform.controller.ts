...
/**
 * Blankevaluationform Controller
 * ====================
 * @author MarioMonir
 */
...
/**
 * import { Blankevaluationform } from "@prisma/client";
 * import { blankevaluationformUseCase1Service } from "./blankevaluationform-services/blankevaluationformUseCase1.service";
 */

// ----------------------------------------------------------------

const entity = `blankevaluationform`;
const path = `/blankevaluationform`;
