...
/**
 * Evaluationquestions Controller
 * ====================
 * @author MarioMonir
 */
...
/**
 * import { Evaluationquestions } from "@prisma/client";
 * import { evaluationquestionsUseCase1Service } from "./evaluationquestions-services/evaluationquestionsUseCase1.service";
 */

// ----------------------------------------------------------------

const entity = `evaluationquestions`;
const path = `/evaluationquestions`;
