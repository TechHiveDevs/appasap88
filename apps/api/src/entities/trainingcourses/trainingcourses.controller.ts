...
/**
 * import { Trainingcourses } from "@prisma/client";
 * import { trainingcoursesUseCase1Service } from "./trainingcourses-services/trainingcoursesUseCase1.service";
 */

// ----------------------------------------------------------------

const entity = `trainingcourses`;
const path = `/trainingcourses`;
